...
public class Program
{
    public static void Main()
    {
        ...
        Console.WriteLine(bestGame.TotalManaSpent);
    }
    ...
    class Spell
    {
        ...
        public static Spell Create(string name, int mana, int damage = 0, int heal = 0, int armour = 0,
            int manaCharge = 0, int duration = 0)
        {
            return new Spell
            {
                Name = name, Mana = mana, Damage = damage, Heal = heal, Armour = armour, ManaCharge = manaCharge,
                Duration = duration
            };
        }
